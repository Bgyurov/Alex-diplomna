...
export const EditAd = ({}) => {
  ...
  useEffect(() => {
    adService.getOne(adId).then((result) => {
      changeValues(result);
    });
  }, [adId]);
      ...
      <form id="edit" method="post" onSubmit={onSubmit}>
        <div className="container">
          ...
          <div className="row">
            ...
            <label htmlFor="game-img">Снимка 2:</label>
            <input
              ...
              id="imageUrl2"
              name="imageUrl2"
              placeholder="Upload a second photo..."
            />
            ...
            <textarea
              ...
              required
            ></textarea>
            <input className="btn submit" type="submit" value="Edit your ad" />
          </div>
        </div>
      </form>
    </section>
